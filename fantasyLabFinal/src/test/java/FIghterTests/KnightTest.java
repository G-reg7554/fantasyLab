...
public class KnightTest {
    ...
    public void getNameTest(){
        assertEquals("Sir Dance Alot", knight.getName());
    }

    @Test
    public void getHealthTest(){
        assertEquals(150, knight.getNoOfHealthPoints());
    }

    @Test
    public void getGoldZeroTest(){
        assertEquals(0, knight.getNoOfGoldCoins());
    }

    @Test
    public void getGold100Test(){
        knight.giveLoot(entranceRoom.getLoot(goldChest).loot(150));
        assertEquals(150, knight.getNoOfGoldCoins());
    }
