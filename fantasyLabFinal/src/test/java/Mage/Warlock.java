...
public class Warlock {
    ...
    public void setUp(){
        ...
        warlock = new Players.Warlock("Hogfarts", 200, 0, fireball, ogre);
    ...
    public void getNameTest(){
        assertEquals("Hogfarts", warlock.getName());
    }

    @Test
    public void getHealthTest(){
        assertEquals(200, warlock.getNoOfHealthPoints());
    }

    @Test
    public void getGoldZeroTest(){
        assertEquals(0, warlock.getNoOfGoldCoins());
    }

    @Test
    public void getGold100Test(){
        warlock.giveLoot(entranceRoom.getLoot(goldChest).loot(150));
        assertEquals(150, warlock.getNoOfGoldCoins());
    }
